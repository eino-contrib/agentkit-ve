...
require (
	...
	github.com/cloudwego/eino-ext/components/model/arkbot v0.1.0
	github.com/cloudwego/eino-ext/components/model/claude v0.1.9
	github.com/cloudwego/eino-ext/components/model/deepseek v0.0.0-20251105030607-6766df40f191
...
require (
	...
	github.com/eino-contrib/agentkit-ve/libs/veauth v0.0.0-20251111090432-f05b7de11886 // indirect
